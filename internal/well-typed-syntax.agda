...
mutual
  ...
  data Term : ∀ {Γ} → Typ Γ → Set where
    ...
    qquote-term-under-app' : {f : Term (‘Typ’ ‘’ ⌜ ε ▻ ‘Σ'’ ‘Context’ ‘Typ’ ⌝c)}
      {t : Term (‘Σ'’ ‘Context’ ‘Typ’)} →
      {- normal form of ∀ {f} {t : □ (‘Σ’ ‘Context’ ‘Typ’)} →
            □ (‘□’ ‘’
                (f ‘‘’’ ⌜ S₁₀WW (S∀ (‘existT'’ ‘’ₐ (‘proj₁'’ ‘'’ₐ t)) ‘’ₐ β (S₀₀W1 (‘proj₂'’ ‘t’ t))) ⌝t ‘‘→'’’ f ‘‘’’ (‘quote-sigma’ ‘'’ₐ t))) -}
      Term
      (‘Term’ ‘’₁ ⌜ ε ⌝c ‘’
       ...
       (substTyp2-substTyp1-substTyp-weakenTyp
        (‘λ∙’
              ...
              (weakenTyp-substTyp-tProd
               (w
                (‘λ∙’
                 ...
                 ‘’ₐ
                 substTyp-weakenTyp
                 (substTyp-weakenTyp (‘substTyp’ ‘’ₐ f) ‘’ₐ
                  ⌜
                  substTyp-weakenTyp
                  (substTyp1-substTyp-weakenTyp
                   (substTyp-weakenTyp
                    (‘λ∙’
                     (weakenTyp-substTyp-tProd
                      (w (‘existT'’ ‘’ₐ substTyp-weakenTyp (‘proj₁'’ ‘’ₐ t))))
                     ‘’ₐ substTyp-weakenTyp (‘proj₁'’ ‘’ₐ t))
                    ‘’ₐ
                    beta-under-subst
                    (substTyp-weakenTyp
                     (‘λ∙’
                      (weakenTyp-substTyp-substTyp-weakenTyp1 (w (‘λ∙’ ‘proj₂'’ ‘’ₐ t)))
                      ‘’ₐ (‘λ∙’ ‘proj₂'’ ‘’ₐ t)))))
                  ⌝t))))
              ‘’ₐ
              substTyp-weakenTyp
         ...
         (substTyp-weakenTyp
          (substTyp-weakenTyp (‘substTyp’ ‘’ₐ f) ‘’ₐ
           substTyp-weakenTyp (‘quote-sigma’ ‘’ₐ t))))))
    {-‘Σ’-η-under-app : {f : Typ (ε ▻ ‘Σ'’ ‘Context’ ‘Typ’)}
    {- normal form of ∀ {f} {t : Term {ε} (‘Σ'’ ‘Context’ ‘Typ’)} →
          Term {ε} (f ‘’ t ‘→’ W (f ‘’ S₁₀WW (S∀ (‘existT'’ ‘’ₐ (‘proj₁'’ ‘'’ₐ t)) ‘’ₐ β (S₀₀W1 (‘proj₂'’ ‘t’ t))))) -}
      {t : Term (‘Σ'’ ‘Context’ ‘Typ’)} →
      Term
      (f ‘’ t ‘→’
       W
         ...
         (substTyp-weakenTyp
          ...
          (substTyp-weakenTyp
           (‘λ∙’
            (weakenTyp-substTyp-substTyp-weakenTyp1 (w (‘λ∙’ ‘proj₂'’ ‘’ₐ t)))
            ‘’ₐ (‘λ∙’ ‘proj₂'’ ‘’ₐ t)))))))
    ‘‘Σ’’-η-under-app : {f : Term {ε} (‘Typ’ ‘’ ⌜ ε ▻ ‘Σ'’ ‘Context’ ‘Typ’ ⌝c)}
      {t : Term (‘Σ'’ ‘Context’ ‘Typ’)} →
{- normal form of
∀ {f} {t : □ (‘Σ’ ‘Context’ ‘Typ’)} →
          □ (‘□’ ‘’
              ...
              (weakenTyp-substTyp-tProd
               (w
                (‘λ∙’
                 ...
                 ‘’ₐ
                 substTyp-weakenTyp
                 (substTyp-weakenTyp (‘substTyp’ ‘’ₐ f) ‘’ₐ ⌜ t ⌝t))))
              ‘’ₐ
              substTyp-weakenTyp
              (substTyp-weakenTyp (‘substTyp’ ‘’ₐ f) ‘’ₐ ⌜ t ⌝t))))
           ‘’ₐ ‘VAR₀’))
