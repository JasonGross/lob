...
_‘’ₙ_ {Γ' = ε'} ‘Context’ x = ‘Context’
_‘’ₙ_ {Γ' = ε'} (‘Type’ C) x = ‘Type’ (C ‘’ₜₙ x)
_‘’ₙ_ {Γ' = ε'} (‘Term’ C T) x = ‘Term’ (C ‘’ₜₙ x) (T ‘’ₜₙ x)
_‘’ₙ_ {Γ' = ε'} (A ‘→’ B) x = (A ‘’ₙ x) ‘→’ (B ‘’ₙ x)
_‘’ₙ_ {Γ} {_} {ε'} (‘Σ’ A B) x = ‘Σ’ (A ‘’ₙ x) {!_‘’ₙ_ {Γ} {_} {ε' ▻' _} B x!}
_‘’ₙ_ {Γ' = ε'} ‘⊤’ x = ‘⊤’
_‘’ₙ_ {Γ' = ε'} ‘⊥’ x = ‘⊥’
_‘’ₙ_ {Γ' = ε'} (wkT₀ T) x = {!!}
_‘’ₙ_ {Γ' = ε'} Δ→Type x = Δ→Type
